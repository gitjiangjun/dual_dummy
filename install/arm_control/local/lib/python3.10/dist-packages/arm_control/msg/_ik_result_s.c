...
bool arm_control__msg__ik_result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("arm_control.msg._ik_result.IKResult", full_classname_dest, 35) == 0);
  }
  arm_control__msg__IKResult * ros_message = _ros_message;
  {  // arm_name
...
{
  /* NOTE(esteve): Call constructor of IKResult */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("arm_control.msg._ik_result");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "IKResult");
