...
class Dummy2ArmControllerServer(rclpy.action.ActionServer):
    def __init__(self, node):
        super().__init__(node, FollowJointTrajectory, 'left_arm_controller/follow_joint_trajectory', self.execute_callback)
        self._node = node
        self._node.get_logger().info("left Arm Controller Server started")
        ...
        self.joint_names = ['left_joint2', 'left_joint1', 'left_joint4', 'left_joint5', 'left_joint6', 'left_joint3', 'left_figer1', 'left_figer2']
