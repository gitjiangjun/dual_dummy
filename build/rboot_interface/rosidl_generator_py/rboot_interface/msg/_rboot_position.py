...
class Metaclass_RbootPosition(type):
    """Metaclass of message 'RbootPosition'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'rboot_interface.msg.RbootPosition')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__rboot_position
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__rboot_position
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__rboot_position
            cls._TYPE_SUPPORT = module.type_support_msg__msg__rboot_position
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__rboot_position
...
class RbootPosition(metaclass=Metaclass_RbootPosition):
    """Message class 'RbootPosition'."""
    ...
    def nodeid(self, value):
        if __debug__:
            ...
            assert value >= -2147483648 and value < 2147483648, \
                "The 'nodeid' field must be an integer in [-2147483648, 2147483647]"
        self._nodeid = value
