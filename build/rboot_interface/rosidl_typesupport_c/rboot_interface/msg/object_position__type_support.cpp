...
static const _ObjectPosition_type_support_symbol_names_t _ObjectPosition_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rboot_interface, msg, ObjectPosition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rboot_interface, msg, ObjectPosition)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rboot_interface, msg, ObjectPosition)() {
  return &::rboot_interface::msg::rosidl_typesupport_c::ObjectPosition_message_type_support_handle;
}
