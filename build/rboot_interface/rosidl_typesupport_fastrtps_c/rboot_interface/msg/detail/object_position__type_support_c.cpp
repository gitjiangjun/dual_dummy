...
#include "rboot_interface/msg/detail/object_position__rosidl_typesupport_fastrtps_c.h"
...
using _ObjectPosition__ros_msg_type = rboot_interface__msg__ObjectPosition;
...
size_t get_serialized_size_rboot_interface__msg__ObjectPosition(
  const void * untyped_ros_message,
...
static uint32_t _ObjectPosition__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rboot_interface__msg__ObjectPosition(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rboot_interface
size_t max_serialized_size_rboot_interface__msg__ObjectPosition(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rboot_interface__msg__ObjectPosition;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
static size_t _ObjectPosition__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rboot_interface__msg__ObjectPosition(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rboot_interface, msg, ObjectPosition)() {
