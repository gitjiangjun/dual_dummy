...
class Dummy2ArmControllerServer(rclpy.action.ActionServer):
    def __init__(self, node):
        super().__init__(node, FollowJointTrajectory, 'right_arm_controller/follow_joint_trajectory', self.execute_callback)
        self._node = node
        self._node.get_logger().info("right Arm Controller Server started")

        self.client = rbootlibs.UDPClient('192.168.8.89', 9999)
        self.client.connect()
        ...
        self.joint_names = ['right_joint2', 'right_joint1', 'right_joint4', 'right_joint5', 'right_joint6', 'right_joint3', 'right_figer1', 'right_figer2']
