...
bool arm_control__msg__trajectory_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("arm_control.msg._trajectory_point.TrajectoryPoint", full_classname_dest, 49) == 0);
  }
  arm_control__msg__TrajectoryPoint * ros_message = _ros_message;
  {  // arm_name
  ...
  {  // time_from_start
    ...
    ros_message->time_from_start = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * arm_control__msg__trajectory_point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("arm_control.msg._trajectory_point");
