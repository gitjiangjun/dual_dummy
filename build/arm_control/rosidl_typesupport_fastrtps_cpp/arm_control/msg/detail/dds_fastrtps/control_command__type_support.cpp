...
#include "arm_control/msg/detail/control_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const arm_control::msg::ControlCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  arm_control::msg::ControlCommand & ros_message)
{
  // Member: arm_name
  cdr >> ros_message.arm_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = arm_control::msg::ControlCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const arm_control::msg::ControlCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<arm_control::msg::ControlCommand *>(
    untyped_ros_message);
...
{
  return &arm_control::msg::typesupport_fastrtps_cpp::_ControlCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arm_control, msg, ControlCommand)() {
  return &arm_control::msg::typesupport_fastrtps_cpp::_ControlCommand__handle;
}
